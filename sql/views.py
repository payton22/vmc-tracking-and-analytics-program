...
def rebuild_db(request):
    ...
    conn.execute(
        'CREATE TABLE demographics(student_name TEXT, student_email TEXT, student_id INTEGER,  classification TEXT, major TEXT, benefit_chapter INTEGER, is_stem INTEGER, currently_live TEXT, employment TEXT, work_hours TEXT, dependents TEXT, marital_status TEXT, gender TEXT, parent_education TEXT, break_in_attendance TEXT)');
